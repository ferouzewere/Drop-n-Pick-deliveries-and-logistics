...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            ...
            <img src="/icons/icons8_user_1.ico" alt="" width="38px">
        </div>
    </nav>
            ...
            <hbndiv class="col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="badge badge-secondary badge-pill"><label for=""></label></span>
                    </h4>
                    <ul class="list-group mb-3">
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0">Parcel Description</h6>
                                <label for="">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0">Price group</h6>
                                <label for="">
                                    <small class="text-muted">15-25 Kg</small>
                                </label>
                            </div>
                            <label for="">
        ...
        <div class="row text-center">
            ...
            <div class="d-block my-3">
                <div class="custom-control custom-radio">
                    ...
                    <label class="custom-control-label" for="credit">Cash (By sender/recepient)</label>
                </div>
                <div class="custom-control custom-radio">
    ...
    <footer class="my-5 pt-3 text-muted text-center text-small">
        <p class="mb-1">&copy; 2022 Drop n Pick</p>
        <ul class="list-inline">
            <li class="list-inline-item"><a href="#">Privacy</a></li>
            <li class="list-inline-item"><a href="#">Terms</a></li>
            <li class="list-inline-item"><a href="#">Support</a></li>
